...
- [4.0 Command Line Interface (CLI)](#40-command-line-interface-cli)
  - [4.1 codemelted (native command)](#41-codemelted-native-command)
    - [4.1.1 Installation / Removal](#411-installation--removal)
    - [4.1.2 Commands](#412-commands)
    - [4.1.3 --async-\* Actions](#413---async--actions)
    - [4.1.4 --console-\* Actions](#414---console--actions)
      - [4.1.4.1 STDIN Actions](#4141-stdin-actions)
      - [4.1.4.2 STDOUT Actions](#4142-stdout-actions)
    - [4.1.5 --npu-\* Actions](#415---npu--actions)
  - [4.2 codemelted-cli (pwsh Core Module)](#42-codemelted-cli-pwsh-core-module)
  - [4.3 Scripting Language Notes](#43-scripting-language-notes)
